...
def test_low_cpu_signal_is_evidence_based():
    result = correlate_cost_and_utilization(
        [{"resource_id": "i-test", "cost": 50.0}],
        [{"instance_id": "i-test", "cpu_average_pct": 5.0, "cpu_max_pct": 20.0, "cpu_datapoints": 10}],
    )
